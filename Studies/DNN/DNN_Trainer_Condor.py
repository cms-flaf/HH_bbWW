...
if __name__ == '__main__':
    ...
    try:
        ...
        model = DNNClass.train_dnn(setup, args.training_file, args.weight_file, config_dict, args.test_training_file, args.test_weight_file, test_config_dict, args.output_folder)
