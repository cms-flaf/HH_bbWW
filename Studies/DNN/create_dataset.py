...
if __name__ == "__main__":
    ...
    create_signal_files_gfal(config_dict, output_folder, args.era)
    print("Creating the batch dict")
    create_dict_gfal(config_dict, output_folder, args.era)
    ...
    for i, yamlname in enumerate(yaml_list):
        ...
        if not os.path.exists(HME_friend_name):
            add_HME(
                config_dict,
                output_folder,
                os.path.join(output_folder, config_dict["meta_data"]["input_filename"]),
        ...
        DNN_friend_name = (
            ...
            + "_DNN_Friend.root"
        if not os.path.exists(DNN_friend_name):
            add_DNN(
                config_dict,
                output_folder,
                os.path.join(output_folder, config_dict["meta_data"]["input_filename"]),
