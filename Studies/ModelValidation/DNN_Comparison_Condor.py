...
if __name__ == "__main__":
    ...
    parser.add_argument("--limit_paths", required=True, nargs="+", type=str, default=None)
    ...
    try:
        ...
        for training in args.limit_paths:
            training_yamls_resolved = [ yam for yam in os.listdir(training) if yam.endswith(".yaml") and "Resolved" in yam ]
            training_yamls_boosted = [ yam for yam in os.listdir(training) if yam.endswith(".yaml") and "Boosted" in yam ]
            ...
            for var in plot_vars:
                ...
                if training_config_boosted['learning_rate'] > 0.001: continue
